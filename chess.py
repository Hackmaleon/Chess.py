   ...
   #calcula los movimientos posibles 
    ...
    #calcula las longitudes de las diagonales
        ...
        for i in range(casillas_posibles1): 
            ...
            for a in sprites_list:
                if casillas1.get(k)[0] == a.rect.x & casillas1.get(k)[1] == a.rect.y:
                    for b in black:
                        if b==a:
                            del casillas1[k]
                    break
        ...
        for i in range(casillas_posibles2): 
            ...
            for a in sprites_list:
                if casillas2.get(k)[0] == a.rect.x & casillas2.get(k)[1] == a.rect.y:
                    for b in black:
                        if b==a:
                            del casillas2[k]
                    break
        ...
        for i in range(casillas_posibles3): 
            ...
            for a in sprites_list:
                if casillas3.get(k)[0] == a.rect.x & casillas3.get(k)[1] == a.rect.y:
                    for b in black:
                        if b==a:
                            del casillas3[k]
                    break
...
Br0.rect.x, Br0.rect.y = casillas["A8"]
